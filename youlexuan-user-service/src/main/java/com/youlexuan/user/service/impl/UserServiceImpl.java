...
public class UserServiceImpl implements UserService {
	...
	public void createSmsCode(String phone) {
		//1.生成6位随机数
		String  str  =(Math.random()*1000000+"").substring(0,6);
		System.out.println("验证码==="+str);
		//存入缓存
		redisTemplate.boundHashOps("smcsode").put(phone,str);
	...
	public boolean  checkSmsCode(String phone,String code){
		//得到缓存中存储的验证码
		String sysCode = (String) redisTemplate.boundHashOps("smcsode").get(phone);
		if(sysCode==null){
			return false;
		}
